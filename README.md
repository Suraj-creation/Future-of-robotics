...
1. UR5 challenge stack (ROS 2 Jazzy + Gazebo + MoveIt) with full process and training guide.
...
- UR5 end-to-end challenge guide:
...
- [physical-ai-challenge-2026](physical-ai-challenge-2026)
  - Main simulation and autonomy workspace for UR5.
...
- UR5 Runbook: [physical-ai-challenge-2026/runbook.md](physical-ai-challenge-2026/runbook.md)
